...
echo '<form method="POST" action="valider_modification_projet1.php">';
			...
			echo 'Explication:<input type="text" name="explication" style="height:50vh; width:20vh; word-break: break-word;" autofocus="true" value="'.$data1['explication'].'"maxlength="1000"><br/><br/>';
